...
#include <asm/arch-mx6/mx6.h>
#include <asm/arch-mx6/iomux-v3.h>
...
int board_ehci_hcd_init(int port) __attribute__((weak, alias("__board_ehci_hcd_init")));
...
int ehci_hcd_init(void)
{
	...
	if(board_ehci_hcd_init(CONFIG_MXC_USB_PORT))
		return -1;
